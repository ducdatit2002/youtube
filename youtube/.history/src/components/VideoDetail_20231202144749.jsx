...
import { getVideoId } from "../utils/fetchFromAPI";
import { getVideoAPI, getCommentVideoId } from "../utils/fetchFromAPI";
const VideoDetail = () => {
                    ...
                    {comments.map(item=> {
                      return (
                        <div className="d-flex flex-start ">
                          ...
                          <img className="rounded-circle shadow-1-strong me-3" src={item.user.full_name} alt="avatar" width={60} height={60} />
